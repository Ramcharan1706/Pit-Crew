...
// import { IntentFactory } from '../contracts/Intent'
...
const AppCalls = ({ openModal, setModalState }: AppCallsInterface) => {
  ...
  const sendAppCall = async () => {
    enqueueSnackbar('App calls are not available in the MVP. Use intent management instead.', { variant: 'info' })
  }

  /* Disabled for MVP - contract functionality not implemented yet
  const sendAppCall = async () => {
    setLoading(true)
    ...
    const factory = new IntentFactory({
